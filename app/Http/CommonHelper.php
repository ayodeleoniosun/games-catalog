...
trait CommonHelper
{
    ...
    public static function getPlayerIdFromToken(Request $request) {
    ...
    public static function getMonthName($month) {
        ...
        $the_month = $months[$month];
        
        return $the_month;
    }

    public static function convertToReadableDate($date) {
        $split_date = explode("-", $date);
        $month_name = self::getMonthName($split_date[1]);
        $readable_date = $month_name." ".$split_date[2].", ".$split_date[0];
